  ...
  return <div className="site-shell">
    ...
    <div className="site-chrome">
      ...
      <header className="site-header"><div className="container nav-row">
        <Link href="/" className="brand" aria-label="Rosales Landscaping & Construction home"><img src={assets.logo} alt="Rosales Landscaping & Construction Inc" width={640} height={304} /></Link>
