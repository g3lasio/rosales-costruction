...
const stages: Stage[] = [
  { number: "01", icon: ClipboardCheck, image: assets.frontApproachBefore, alt: { en: "Outdoor kitchen masonry taking shape before finish work", es: "Mampostería de cocina exterior tomando forma antes de los acabados" }, label: { en: "Prepare", es: "Preparar" }, title: { en: "Read the site first.", es: "Primero, entender el terreno." }, body: { en: "We begin by discussing the intended use and reviewing access, surface conditions, grade, materials, and the best way to approach the work.", es: "Comenzamos hablando del uso previsto y revisando acceso, condiciones de la superficie, niveles, materiales y la mejor forma de abordar el trabajo." }, note: { en: "Scope · site conditions · approach", es: "Alcance · condiciones · enfoque" } },
